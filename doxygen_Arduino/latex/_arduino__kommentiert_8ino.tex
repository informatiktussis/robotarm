...
\begin{DoxyCode}
189 \{
195   \textcolor{keywordflow}{if} (\hyperlink{_arduino__kommentiert_8ino_a92309e3a6d185d9188757bac49168fe5}{esp\_server}.\hyperlink{class_esp_server_a4549a76725f2e4c013e4d57018366109}{available}()) \{
196 
197     String command = \hyperlink{_arduino__kommentiert_8ino_a92309e3a6d185d9188757bac49168fe5}{esp\_server}.readStringUntil(\textcolor{charliteral}{'\(\backslash\)n'});
198 
212     \textcolor{keywordflow}{if} (command == \textcolor{stringliteral}{"a"}) \{
213       \hyperlink{_arduino__kommentiert_8ino_a409d566aad8f36a68f5c2ec46ce59393}{python\_button\_var} = 97;
214     \}
215     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (command == \textcolor{stringliteral}{"b"}) \{
216       \hyperlink{_arduino__kommentiert_8ino_a409d566aad8f36a68f5c2ec46ce59393}{python\_button\_var} = 98;
217     \}
218     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (command == \textcolor{stringliteral}{"c"}) \{
219       \hyperlink{_arduino__kommentiert_8ino_a409d566aad8f36a68f5c2ec46ce59393}{python\_button\_var} = 99;
220     \}
221     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (command == \textcolor{stringliteral}{"d"}) \{
222       \hyperlink{_arduino__kommentiert_8ino_a409d566aad8f36a68f5c2ec46ce59393}{python\_button\_var} = 100;
223     \}
224     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (command == \textcolor{stringliteral}{"e"}) \{
225       \hyperlink{_arduino__kommentiert_8ino_a409d566aad8f36a68f5c2ec46ce59393}{python\_button\_var} = 101;
226     \}
227     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (command == \textcolor{stringliteral}{"f"}) \{
228       \hyperlink{_arduino__kommentiert_8ino_a409d566aad8f36a68f5c2ec46ce59393}{python\_button\_var} = 102;
229     \}
230     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (command == \textcolor{stringliteral}{"g"}) \{
231       \hyperlink{_arduino__kommentiert_8ino_a409d566aad8f36a68f5c2ec46ce59393}{python\_button\_var} = 103;
232     \}
233     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (command == \textcolor{stringliteral}{"h"}) \{
234       \hyperlink{_arduino__kommentiert_8ino_a409d566aad8f36a68f5c2ec46ce59393}{python\_button\_var} = 104;
235     \}
236     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (command == \textcolor{stringliteral}{"i"}) \{
237       \hyperlink{_arduino__kommentiert_8ino_a409d566aad8f36a68f5c2ec46ce59393}{python\_button\_var} = 105;
238     \}
239     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (command == \textcolor{stringliteral}{"j"}) \{
240       \hyperlink{_arduino__kommentiert_8ino_a409d566aad8f36a68f5c2ec46ce59393}{python\_button\_var} = 106;
241     \}
242     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (command == \textcolor{stringliteral}{"k"}) \{
243       \hyperlink{_arduino__kommentiert_8ino_a409d566aad8f36a68f5c2ec46ce59393}{python\_button\_var} = 107;
244     \}
245     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (command == \textcolor{stringliteral}{"1"}) \{
246       \hyperlink{_arduino__kommentiert_8ino_a409d566aad8f36a68f5c2ec46ce59393}{python\_button\_var} = 49;
247     \}
248     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (command == \textcolor{stringliteral}{"2"}) \{
249       \hyperlink{_arduino__kommentiert_8ino_a409d566aad8f36a68f5c2ec46ce59393}{python\_button\_var} = 50;
250     \}
251     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (command == \textcolor{stringliteral}{"3"}) \{
252       \hyperlink{_arduino__kommentiert_8ino_a409d566aad8f36a68f5c2ec46ce59393}{python\_button\_var} = 51;
253     \}
254     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (command == \textcolor{stringliteral}{"4"}) \{
255       \hyperlink{_arduino__kommentiert_8ino_a409d566aad8f36a68f5c2ec46ce59393}{python\_button\_var} = 52;
256     \}
257     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (command == \textcolor{stringliteral}{"5"}) \{
258       \hyperlink{_arduino__kommentiert_8ino_a409d566aad8f36a68f5c2ec46ce59393}{python\_button\_var} = 53;
259     \}
260     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (command == \textcolor{stringliteral}{"6"}) \{
261       \hyperlink{_arduino__kommentiert_8ino_a409d566aad8f36a68f5c2ec46ce59393}{python\_button\_var} = 54;
262     \}
263   \}
264 
276   \textcolor{keywordflow}{switch} (\hyperlink{_arduino__kommentiert_8ino_a409d566aad8f36a68f5c2ec46ce59393}{python\_button\_var}) \{
277 
278     \textcolor{keywordflow}{case} 97: \hyperlink{_arduino__kommentiert_8ino_a74bfcf85e5418694eb99df53d30c8fab}{arm\_hoch}(180, &\hyperlink{_arduino__kommentiert_8ino_ac5d2bea44c6318454db0e2639a4efe95}{servo1});   \textcolor{keywordflow}{break}; \textcolor{comment}{//a}
279     \textcolor{keywordflow}{case} 98: \hyperlink{_arduino__kommentiert_8ino_a5b873994166a952d81f787c307ca08d9}{arm\_runter}(11, &\hyperlink{_arduino__kommentiert_8ino_ac5d2bea44c6318454db0e2639a4efe95}{servo1});  \textcolor{keywordflow}{break}; \textcolor{comment}{//b}
280 
281     \textcolor{keywordflow}{case} 99: \hyperlink{_arduino__kommentiert_8ino_a74bfcf85e5418694eb99df53d30c8fab}{arm\_hoch}(180, &\hyperlink{_arduino__kommentiert_8ino_a6458146b8e54c3729bbee8c037921c72}{servo2});   \textcolor{keywordflow}{break}; \textcolor{comment}{//c}
282     \textcolor{keywordflow}{case} 100: \hyperlink{_arduino__kommentiert_8ino_a5b873994166a952d81f787c307ca08d9}{arm\_runter}(20, &\hyperlink{_arduino__kommentiert_8ino_a6458146b8e54c3729bbee8c037921c72}{servo2});  \textcolor{keywordflow}{break}; \textcolor{comment}{//d}
283 
284     \textcolor{keywordflow}{case} 101: \hyperlink{_arduino__kommentiert_8ino_a74bfcf85e5418694eb99df53d30c8fab}{arm\_hoch}(180, &\hyperlink{_arduino__kommentiert_8ino_a7c0244e667b5f7c873df01946f0767bd}{servo3});   \textcolor{keywordflow}{break}; \textcolor{comment}{//e}
285     \textcolor{keywordflow}{case} 102: \hyperlink{_arduino__kommentiert_8ino_a5b873994166a952d81f787c307ca08d9}{arm\_runter}(11, &\hyperlink{_arduino__kommentiert_8ino_a7c0244e667b5f7c873df01946f0767bd}{servo3});  \textcolor{keywordflow}{break}; \textcolor{comment}{//f}
286 
287     \textcolor{keywordflow}{case} 103: \hyperlink{_arduino__kommentiert_8ino_a74bfcf85e5418694eb99df53d30c8fab}{arm\_hoch}(180, &\hyperlink{_arduino__kommentiert_8ino_a207f149c99b91a8bacd26b8b70dfc71c}{servo4});   \textcolor{keywordflow}{break}; \textcolor{comment}{//g}
288     \textcolor{keywordflow}{case} 104: \hyperlink{_arduino__kommentiert_8ino_a5b873994166a952d81f787c307ca08d9}{arm\_runter}(45, &\hyperlink{_arduino__kommentiert_8ino_a207f149c99b91a8bacd26b8b70dfc71c}{servo4});  \textcolor{keywordflow}{break}; \textcolor{comment}{//h}
289 
290     \textcolor{keywordflow}{case} 105: \hyperlink{_arduino__kommentiert_8ino_ac03f54892f7473625ec7d6498ea5a010}{spezial\_funktion\_hoch}(180, &\hyperlink{_arduino__kommentiert_8ino_a6458146b8e54c3729bbee8c037921c72}{servo2}, &
...
291     \textcolor{keywordflow}{case} 106: \hyperlink{_arduino__kommentiert_8ino_abf7a5d6cd0eca7c0dacb61f5ef555beb}{spezial\_funktion\_runter}(20, &\hyperlink{_arduino__kommentiert_8ino_a6458146b8e54c3729bbee8c037921c72}{servo2}, &
...
292 
299     \textcolor{keywordflow}{case} 107: \textcolor{keywordflow}{break}; 
307     \textcolor{keywordflow}{case} 49: \hyperlink{_arduino__kommentiert_8ino_a8b03f5396d8e845086daab48dcaca5cb}{speed\_var} = 5; \textcolor{keywordflow}{break};
308     \textcolor{keywordflow}{case} 50: \hyperlink{_arduino__kommentiert_8ino_a8b03f5396d8e845086daab48dcaca5cb}{speed\_var} = 8;  \textcolor{keywordflow}{break};
309     \textcolor{keywordflow}{case} 51: \hyperlink{_arduino__kommentiert_8ino_a8b03f5396d8e845086daab48dcaca5cb}{speed\_var} = 11; \textcolor{keywordflow}{break};
310     \textcolor{keywordflow}{case} 52: \hyperlink{_arduino__kommentiert_8ino_a8b03f5396d8e845086daab48dcaca5cb}{speed\_var} = 14; \textcolor{keywordflow}{break};
311     \textcolor{keywordflow}{case} 53: \hyperlink{_arduino__kommentiert_8ino_a8b03f5396d8e845086daab48dcaca5cb}{speed\_var} = 17; \textcolor{keywordflow}{break};
312     \textcolor{keywordflow}{case} 54: \hyperlink{_arduino__kommentiert_8ino_a8b03f5396d8e845086daab48dcaca5cb}{speed\_var} = 20; \textcolor{keywordflow}{break};
313   \}
314 
315 \}
\end{DoxyCode}
...
Definiert in Zeile 42 der Datei Arduino\+\_\+kommentiert.\+ino.
...
Definiert in Zeile 43 der Datei Arduino\+\_\+kommentiert.\+ino.
...
Definiert in Zeile 44 der Datei Arduino\+\_\+kommentiert.\+ino.
...
Definiert in Zeile 50 der Datei Arduino\+\_\+kommentiert.\+ino.
...
Definiert in Zeile 51 der Datei Arduino\+\_\+kommentiert.\+ino.
...
Definiert in Zeile 52 der Datei Arduino\+\_\+kommentiert.\+ino.
...
Definiert in Zeile 53 der Datei Arduino\+\_\+kommentiert.\+ino.
...
Definiert in Zeile 59 der Datei Arduino\+\_\+kommentiert.\+ino.
