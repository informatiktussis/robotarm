...
Dazu müssen zunächst Variablen als Servos geklariert werden (siehe Abbildung 3 Zeile 7-10) und daraufhin auf welchen Pin (Zeile 11-14). Diese Pins sind dann an DATA anzuschließen. Im Setup wird dann mit dem Befehl servo.attach($servo\_pin$) der jeweilige Servo einem Pin zugewiesen.
