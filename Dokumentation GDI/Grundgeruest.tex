...
Die zweite Sektion, die Untere, ist dafür da um die Spezialfunktion zu nutzen. Damit das Ganze übersichtlich bleibt, haben wir auch die Buttons für den unteren und den oberen Servomotoren hinzugefügt, so teilt es sich in die zwei verschiedenen Ansteuerungsmöglichkeiten auf, sodass besser nachvollziehbar sind. \\
Die dritte Sektion ist die Geschwindigkeit. In dieser kann einer von sechs Radiobuttons auswählt werden, der die Geschwindigkeiten aller Servos gleichmaßen verändert.
...
Während der jeweilige Buttons gedrückt wird, wird der String gesendet, sodass wenn wir den Button gedrückt halten der Servo durchgehend gesteuert wird. Sollte der Button losgelassen werden, wird das Case 107 ausgeführt, diese bewirkt, dass der jeweilige Servo sich nicht mehr bewegt.\\
