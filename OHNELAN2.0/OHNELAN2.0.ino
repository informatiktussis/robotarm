...
pinMode(led, OUTPUT);
  ...
  esp_server.begin(&esp_serial, "Fany", "123hohoho", 30304);
...
/*
if (python_button_var == 97) {
  arm_hoch(180, &servo1);}
  
else if (python_button_var == 107) {
 arm_runter(11, &servo1);
}
...
if (python_button_var == 97) {
  arm_hoch(180, &servo1);
}else if (python_button_var == 98)
{  arm_runter(11, &servo1);} 

else if (python_button_var == 99)
{  arm_hoch(180, &servo2);} 
else if (python_button_var == 100)
{  arm_runter(11, &servo2);} 
 
else if (python_button_var == 101)
{  arm_hoch(180, &servo3);} 
 else if (python_button_var == 102)
{  arm_runter(11, &servo3);} 
 
else if (python_button_var == 103)
{  arm_hoch(180, &servo4);} 
 else if (python_button_var == 104)
{  arm_runter(11, &servo4);} 
 
else if (python_button_var == 105)
{ spezial_funktion_hoch(180, &servo2, &servo3);} 
 else if (python_button_var == 106)
{ spezial_funktion_runter(11, &servo2, &servo3);} 
